...
if __name__ == "__main__":
    ...
    for dataset_num in dataset_range:
        ...
        depot_df = depot_df[0:depot_length]
        
        depot_num = len(depot_df)
        client_number = len(data_df)

        print("Depot and Client Numbers:", depot_num, client_number)
        ...
        print("Solution Distances per Depot:", solution_distances)
        ...
        print("Solution: ", Total_Solution[ds_title])
        print("Distances: ", Total_Distances[ds_title])
        print("Vehicle Numbers: ", vehicle_nums[ds_title])
        print("Run Time:" ,RunTime[ds_title])
