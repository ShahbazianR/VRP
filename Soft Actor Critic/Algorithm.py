...
def RL_Agent(C, D, TW_C, Demands, Q, T_Service, n_vehicles, n_episodes, n_time_steps, \
    ...
    Agents = ACAgent(input_dims=state_dim, alpha=0.003, beta=0.003, max_actions=action_dim, gamma=0.99, 
                 n_actions=action_dim, max_size=1000000, tau=0.005, layer1_size=256, layer2_size=256, 
                                ...
                                if len(unseen_clients):
                                   ...
                                   # print(current)
                                    ...
                                    if tw_start <= envs[depot][v]['total_time'] <= tw_end: 
                                        ...
                                        Agents.store_memory(current_state, action, reward, next_state, envs[depot][v]['done'])
